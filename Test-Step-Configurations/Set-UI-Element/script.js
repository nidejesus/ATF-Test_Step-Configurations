(function (step, stepResult, assertionObject) {
    ...
    assertionObject.executeStep = function (step, stepResult) {
        ...
        var messages = new GwtMessage().getMessages([MESSAGE_KEY_NO_QUERY_SELECTOR_PROVIDED, MESSAGE_KEY_NO_VALUE_PROVIDED, MESSAGE_KEY_WAITING_FOR_TIMEOUT, MESSAGE_KEY_UI_ELEMENT_NOT_FOUND, MESSAGE_KEY_NO_VALUE_PROVIDED, MESSAGE_KEY_SET_VALUE_SUCCESS, MESSAGE_KEY_UI_ELEMENT_NOT_VISIBLE, MESSAGE_KEY_UI_ELEMENT_READ_ONLY]);
